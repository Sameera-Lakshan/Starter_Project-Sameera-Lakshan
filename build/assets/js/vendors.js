! function() {
  ...
  function t(e) {
    return void 0 === this || Object.getPrototypeOf(this) !== t.prototype ? new t(e) : ((E = this).version = "3.3.6", E.tools = new o, E.isSupported() ? (E.tools.extend(E.defaults, e || {}), E.defaults.container = b(E.defaults), E.store = {
      elements: {},
      containers: []
  ...
  function q() {
    if (E.isSupported()) {
      n();
      for (var e = 0; e < E.store.containers.length; e++) E.store.containers[e].addEventListener("scroll", r), E.store.containers[e].addEventListener("resize", r);
      E.initialized || (window.addEventListener("scroll", r), window.addEventListener("resize", r), E.initialized = !0)
    }
    return E
  }
  ...
  function n() {
    ...
    (function() {
      ...
      E.tools.forOwn(E.sequences, function(e) {
        o = E.sequences[e], n = !1;
        for (var t = 0; t < o.elemIds.length; t++) i = o.elemIds[t], s(E.store.elements[i]) && !n && (n = !0);
        o.active = n
      })
    })(), E.tools.forOwn(E.store.elements, function(e) {
      n = E.store.elements[e], t = function(e) {
        ...
        function(e) {
        ...
        }(n) ? (n.config.beforeReveal(n.domEl), t ? n.domEl.setAttribute("style", n.styles.inline + n.styles.transform.target + n.styles.transition.delayed) : n.domEl.setAttribute("style", n.styles.inline + n.styles.transform.target + n.styles.transition.instant), i("reveal", n, t), n.revealing = !0, n.seen = !0, n.sequence && function(e, t) {
          var n = 0,
            i = 0,
          ...
          o.blocked = !0, t && "onload" === e.config.useDelay && (i = e.config.delay), e.sequence.timer && (n = Math.abs(e.sequence.timer.started - new Date), window.clearTimeout(e.sequence.timer)), e.sequence.timer = {
            ...
            o.blocked = !1, e.sequence.timer = null, r()
        ...
        }(n) && (n.config.beforeReset(n.domEl), n.domEl.setAttribute("style", n.styles.inline + n.styles.transform.initial + n.styles.transition.instant), i("reset", n), n.revealing = !1)
    })
  }
  ...
  function s(e) {
    var t, n, i, o, r, s, a, l, c = w(e.domEl),
      d = function(e) {
        return {
          width: e.clientWidth,
      ...
      p = c.top,
      g = c.left;
    return t = p + y * u, n = g + m * u, i = p + y - y * u, o = g + m - m * u, r = f.y + e.config.viewOffset.top, s = f.x + e.config.viewOffset.left, a = f.y - e.config.viewOffset.bottom + d.height, l = f.x - e.config.viewOffset.right + d.width, t < a && r < i && n < l && s < o || "fixed" === window.getComputedStyle(e.domEl).position
  }
  ...
  t.prototype.defaults = {
    ...
    if (void 0 !== t && "number" == typeof t ? (n = t, t = {}) : null != t || (t = {}), !(r = function(e, t) {
      ...
      }(e, o = b(t))).length) return E;
    n && "number" == typeof n && (c = v(), l = E.sequences[c] = {
      id: c,
      interval: n,
      elemIds: [],
      active: !1
    ...
    return !i && E.isSupported() && (function(e, t, n) {
      ...
      E.history.push(i)
    }(e, t, n), E.initTimeout && window.clearTimeout(E.initTimeout), E.initTimeout = window.setTimeout(q, 0)), E
  ...
  }, o.prototype.extend = function(t, n) {
